...
# Step 5-8 settings (Reproduction defaults)
TASK="${TASK:-helpful}"
...
TRAINING_EPOCHS="${TRAINING_EPOCHS:-30}"  # Increased for reproduction
LEARNING_RATE="${LEARNING_RATE:-0.001}"
SEED="${SEED:-6}"
ANNOTATION_QUALITY="${ANNOTATION_QUALITY:-10}"
ENSEMBLE_NUMBER="${ENSEMBLE_NUMBER:-10}"
DISTILL_EPOCHS="${DISTILL_EPOCHS:-30}"    # Increased for reproduction
NORMALIZE_REWARDS="${NORMALIZE_REWARDS:-1}" # Enabled for better BoN comparison
