...
output_dir = (
    "generated_responses"  # need to change to the output directory of previous steps
)
            ...
            for split in range(5):
                ...
                for line in tqdm(out_data):
                    ...
                    for i in range(n_samples):
                        ...
                        with open(
                            f"temp_out_data/{reward_model}_{model_name}_{data_cls}_{eval_dataset}_database_split{i}.json",
                            "a+",
                        ) as f:
